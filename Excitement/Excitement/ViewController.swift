...
class ViewController: UIViewController, ARSCNViewDelegate, CLLocationManagerDelegate, SCNSceneRendererDelegate{
    ...
    func loadHuman () {
        ...
        let waveScene = SCNScene(named: "art.scnassets/excitement.dae")!
        
        // This node will be parent of all the animation models
        let node = waveScene.rootNode.childNode(withName: "excitement", recursively: true)!
        ...
        node.scale = SCNVector3(1.25, 1.25, 1.25)
...
//            }
            ...
            ship.node.scale = SCNVector3(x: Float(5), y: Float(5), z: Float(5))
